...
Command: npx gltfjsx@6.5.3 public/models/Animals/Deer.gltf -o src/components/Animals/Deer.jsx -r public 
*/
...
export function Deer(props) {
  ...
  const { scene, animations } = useGLTF('/models/Animals/Deer.gltf')
  ...
  const [currentAnimation, setCurrentAnimation] = useState("Idle");
    ...
    useEffect(() => {
      ...
      }, 4000); // Change animation every 2 seconds
      ...
      <group name="Scene">
        <group name="AnimalArmature">
          ...
          <group name="Deer">
            ...
            <skinnedMesh name="Cube_1" geometry={nodes.Cube_1.geometry} material={materials.Hooves} skeleton={nodes.Cube_1.skeleton} />
            ...
            <skinnedMesh name="Cube_4" geometry={nodes.Cube_4.geometry} material={materials.Eye_Lighter} skeleton={nodes.Cube_4.skeleton} />
            <skinnedMesh name="Cube_5" geometry={nodes.Cube_5.geometry} material={materials.Eye_Black} skeleton={nodes.Cube_5.skeleton} />
            <skinnedMesh name="Cube_6" geometry={nodes.Cube_6.geometry} material={materials.Eye_White} skeleton={nodes.Cube_6.skeleton} />
          </group>
        </group>
      </group>
    </group>
