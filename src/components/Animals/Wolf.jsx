...
Command: npx gltfjsx@6.5.3 public/models/Animals/Wolf.gltf -o src/components/Animals/Wolf.jsx -r public 
*/
...
export function Wolf(props) {
  ...
  const { scene, animations } = useGLTF('/models/Animals/Wolf.gltf')
