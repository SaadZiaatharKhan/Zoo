...
Command: npx gltfjsx@6.5.3 public/models/Animals/Bull.gltf -o src/components/Animals/Bull.jsx -r public 
*/
...
export function Bull(props) {
  ...
  const { scene, animations } = useGLTF('/models/Animals/Bull.gltf')
      ...
      <group name="Scene">
        <group name="AnimalArmature">
          ...
          <group name="Cow">
            ...
            <skinnedMesh name="Cube_3" geometry={nodes.Cube_3.geometry} material={materials.Muzzle} skeleton={nodes.Cube_3.skeleton} />
            <skinnedMesh name="Cube_4" geometry={nodes.Cube_4.geometry} material={materials.Eye_Black} skeleton={nodes.Cube_4.skeleton} />
            <skinnedMesh name="Cube_5" geometry={nodes.Cube_5.geometry} material={materials.Eye_White} skeleton={nodes.Cube_5.skeleton} />
            <skinnedMesh name="Cube_6" geometry={nodes.Cube_6.geometry} material={materials.Horns} skeleton={nodes.Cube_6.skeleton} />
          </group>
        </group>
      </group>
    </group>
...
useGLTF.preload('/models/Animals/Bull.gltf')
